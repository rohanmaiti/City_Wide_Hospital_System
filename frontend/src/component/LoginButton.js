  ...
  return (
    <Dropdown>
      ...
      <MenuItem onClick={()=> handleClick("user")}>User</MenuItem>
        <MenuItem onClick={()=> handleClick("doctor")}>Doctor</MenuItem>
        <MenuItem onClick={()=> handleClick("inventory_manager")}>Inventary Manager</MenuItem>
        <MenuItem onClick={()=> handleClick("hospital_admin")}>Hospital Admin</MenuItem>
        <MenuItem onClick={()=> handleClick("super_admin")}>Super Admin</MenuItem>
      </Menu>
    </Dropdown>
  );
}
